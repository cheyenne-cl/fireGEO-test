      ...
      {prompts.map((promptData, idx) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {["OpenAI", "Anthropic", "Google", "Perplexity"].map(
                    (providerName) => {
            ...
            >
              <div className="border-t border-gray-100 px-3 py-3 w-full overflow-hidden">
                  ...
                  <div className="space-y-4 w-full">
                    {["OpenAI", "Anthropic", "Google", "Perplexity"].map(
                      (providerName) => {
                        ...
                        return (
                          <div key={providerName} className="space-y-1 w-full">
                            ...
                            <div className="bg-gray-50 rounded-md p-3 text-sm text-gray-700 select-text cursor-text overflow-hidden break-words">
                              {isFailed ? (
